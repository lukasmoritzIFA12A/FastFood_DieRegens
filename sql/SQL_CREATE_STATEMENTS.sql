...
-- -----------------------------------------------------
-- Table `fastFood`.`Bestellung_Produkt`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fastFood`.`Bestellung_Produkt` ;

CREATE TABLE IF NOT EXISTS `fastFood`.`Bestellung_Produkt` (
  `Bestellung_id` INT NOT NULL,
  `Produkt_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `fastFood`.`Bestellung_Menue`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `fastFood`.`Bestellung_Menue` ;

CREATE TABLE IF NOT EXISTS `fastFood`.`Bestellung_Menue` (
  `Bestellung_id` INT NOT NULL,
  `Menue_id` INT NOT NULL,
