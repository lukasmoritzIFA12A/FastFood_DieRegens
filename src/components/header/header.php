...
if ($showMenu) {
    include '../startseite/produktModal.php';
    include '../startseite/menuModal.php';
}
?>
            ...
            <ul class="navbar-nav"> <!-- Für die letzten beiden Elemente, die ganz rechts sein sollen -->
                ...
                <?php if ($showLogin): ?> <!-- Login nur anzeigen, wenn $showLogin true ist -->
                    <li class="nav-item">
                        <?php if ($isLoggedIn): ?>
                            <?php if ($isAdmin): ?>
                                <a href="<?= router::url('/components/admin/admin-fenster.php') ?>" class="nav-link d-flex">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-gear-fill me-1" viewBox="0 0 16 16">
