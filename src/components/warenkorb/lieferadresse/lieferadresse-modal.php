<div class="modal fade" id="editLieferAdresse" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Lieferadresse bearbeiten</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form method="POST" id="lieferAdresseForm" action="#">
                <div class="modal-body">
                    ...
                    <div class="d-flex gap-5">
                        <div>
                            <label for="newVorname" class="form-label mt-2">Vorname</label>
                            <input type="text" class="form-control" id="newVorname" name="newVorname">
                        </div>
                        <div>
                            <label for="newNachname" class="form-label mt-2">Nachname</label>
                            <input type="text" class="form-control" id="newNachname" name="newNachname">
                        </div>
                    </div>

                    <div>
                        <label for="newTelefonnummer" class="form-label mt-2">Telefonnummer</label>
                        <input type="text" class="form-control" id="newTelefonnummer" name="newTelefonnummer">
                    </div>
                </div>
