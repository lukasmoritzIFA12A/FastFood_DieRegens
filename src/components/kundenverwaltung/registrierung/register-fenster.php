    ...
    <form id="registerForm" action="#" method="POST">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" id="first-name" name="first_name" class="form-control" placeholder="Vorname"
                       required>
            </div>
            <div class="col-md-6">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <input type="text" id="telefon-nummer" name="telefon_nummer" class="form-control"
                       placeholder="Tel. Nummer">
            </div>
            <div class="col-md-4">
                <label for="postleitzahl" class="form-label">PLZ</label>
                <input type="text" id="postleitzahl" name="postleitzahl" class="form-control" placeholder="PLZ"
                       required>
            </div>
            <div class="col-md-4">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-2">
                ...
                <input type="text" id="house-number" name="house_number" class="form-control" placeholder="Haus-Nr."
                       required>
            </div>
            <div class="col-md-2">
        ...
        <p class="text-center mt-3">Bereits Mitglied? <a
                    href="<?= router::url('/components/kundenverwaltung/login/login-fenster.php') ?>">Melde dich an!</a>
        </p>
    </form>
</div>
</body>
