document.getElementById("benutzernameForm").addEventListener("submit", function (event) {
    event.preventDefault(); // Verhindert Standard-Weiterleitung

    let formData = new FormData(this);

    fetch("/FastFood/src/components/kundenverwaltung/account/editieren/benutzername/benutzername-handler.php", {
        method: "POST",
        body: formData
    })
        .then(response => {
