document.getElementById("menueEditForm").addEventListener("submit", function (event) {
    ...
    fetch("/FastFood/src/components/admin/content/edit/menue/menue-edit-handler.php", {
        method: "POST",
        body: formData
    })
        .then(response => {
...
function setMenue(jsonString) {
    ...
    document.getElementById("menuPrice").value = menue.Preis;
...
function addProductToEditMenu(productName, productId) {
    ...
    onPressedButtonAnimation(productName+"Edit");
